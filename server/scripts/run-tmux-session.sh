...
tmux new-session -d -s RustyController 'cp ./server/target/release/rusty_controller /tmp/running_rusty_controller && export RUST_LOG=info,rusty_controller=debug; /tmp/running_rusty_controller'
